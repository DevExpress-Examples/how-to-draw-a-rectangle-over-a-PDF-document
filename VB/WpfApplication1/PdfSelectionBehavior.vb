...
Namespace WpfApplication1
    ...
    Public Class PdfSelectionBehavior
        ...
        Private mouseStartPoint As Point = New Point()
        ...
        Protected Overridable Sub OnPreviewMouseLeftButtonDown(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            If Not(TypeOf e.OriginalSource Is DevExpress.Xpf.PdfViewer.DXScrollViewer) Then Return
            If documentPanel Is Nothing Then Return
        ...
        Protected Overridable Sub DestroyAdorner()
            If selectionAdorner IsNot Nothing Then controlAdornerLayer.Remove(selectionAdorner)
        End Sub

        Protected Overridable Sub UpdateAdorner()
            If selectionAdorner IsNot Nothing Then selectionAdorner.InvalidateVisual()
        End Sub
